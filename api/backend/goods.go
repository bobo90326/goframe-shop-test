...
type GoodsReq struct {
	g.Meta `path:"/user/goods/add" tags:"商品" method:"post" summary:"添加商品"`
...
type GoodsDeleteReq struct {
	g.Meta `path:"/user/goods/delete" method:"delete" tags:"商品" summary:"删除商品接口"`
	Id     uint `v:"min:1#请选择需要删除的商品" dc:"商品id"`
}
type GoodsDeleteRes struct{}

type GoodsUpdateReq struct {
	g.Meta `path:"/user/goods/update/" method:"post" tags:"商品" summary:"修改商品接口"`
...
type GoodsGetListCommonReq struct {
	g.Meta `path:"/user/goods/list" method:"get" tags:"商品" summary:"商品列表接口"`
	CommonPaginationReq
}
