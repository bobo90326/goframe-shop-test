...
// PermissionCreateUpdateBase is the base struct for permission create and update.
type PermissionCreateUpdateBase struct {
	Name string
	Path string
}

// PermissionCreateInput is the input of the permission create.
type PermissionCreateInput struct {
	PermissionCreateUpdateBase
}

// PermissionCreateOutput is the output of the permission create.
